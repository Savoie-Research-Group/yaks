...
import numpy as np
from xtb_functions import write_xcontrol
...
# output:  output_list : contains all output folders 
#
def submit_crest(R_list,output_path,Njobs,conf_path,crest_path=None,xtb_path=None,Wt='4',sched='slurm',queue='standby',nprocs=8,charge=0,unpair=0,fixed_list=None,relax_list=None):
            ...
            with open('CREST.{}.submit'.format(n),'w') as f:                                                                 
                ...
                for reactant in input_reactants:
                    ...
                    if fixed_list is None:
                        ...
                        cons_file = '{}/crest_cons.inp'.format(output_folder)
                        write_xcontrol(cons_file,reference=reactant,fixed_atoms=fixed_list,relax_atoms=relax_list,force_const=1.0)
                        #command_line = '{} {} -bthr 0.001 -athr 0.001 -gfn2 -xnam {} -nozs -chrg {} -uhf {} --cinp {}\n'
                        command_line = '{} {} -gfn2 -xnam {} -nozs -chrg {} -uhf {} --cinp crest_cons.inp\n'
                        command_line = command_line.format(crest_path,reactant,xtb_path,charge,unpair)
                    ...
                    # f.write(f'python {working_dir}/analyze_crest_output.py {output_folder}')
                    f.write("\nwait\n")
