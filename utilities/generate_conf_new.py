...
def main(argv):
    ...
    # if number of conformers less or equal to 2N_max, it will be a conformer poor case
        ...
        if len(pass_obj_values) < N_max - 2 and len(obj_values) > 0:
            ...
            if input_type == 'forward':
                xyz_write('{}/{}_{}.xyz'.format(args.output_folder,args.outputname,count+1),E,RG)
                command_line = "cat {} >> {}/{}_{}.xyz;rm {}".format(tmp_product,args.output_folder,args.outputname,count+1,tmp_product)
            else:
                xyz_write(tmp_reactant,E,RG)
                command_line = "cp {} {}/{}_{}.xyz;cat {} >> {}/{}_{}.xyz;rm {} {}".format(tmp_product,args.output_folder,args.outputname,count+1,tmp_reactant,args.output_folder,args.outputname,count+1,tmp_reactant,tmp_product)
